# [atet](https://github.com/atet) / [**_nas_**](https://github.com/atet/nas?tab=readme-ov-file#atet--nas)

[![.img/logo_nextcloud.png](.img/logo_nextcloud.png)](#nolink)

# Introduction to Network Attached Storage

**This tutorial is part of my series on System Administration:<br>I highly recommend finishing my [15 Minute Introduction to Raspberry Pi](https://github.com/atet/raspberrypi?tab=readme-ov-file#atet--raspberrypi) to put this tutorial in better context**
...
* Please follow sections 2 and 4 in [Atet's 15 Minute Introduction to Raspberry Pi](https://github.com/atet/raspberrypi?tab=readme-ov-file#atet--raspberrypi):
...
* **I highly recommend continuing with another mini project: [Atet's 15 Minute Introduction to Virtualization](https://github.com/atet/virtual?tab=readme-ov-file#atet--virtual)**
